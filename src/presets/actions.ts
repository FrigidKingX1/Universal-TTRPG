...
export const MONSTER_ATTACK_ACTIONS: ActionDefinition[] = [
  ...
  mk("act_ochre_slam", "Slam (Ooze)", "2d6 + @attributes.STR.derived_modifier", "bludgeoning", "STR"),
  ...
  mk("act_breath_acid_brass", "Fire Breath (Brass)", "10d8", "fire", "CON", 30, undefined, { type: "line", sizeFeet: 60 }),
  mk("act_breath_poison_bronze", "Lightning Breath (Bronze)", "11d8", "lightning", "CON", 30, undefined, { type: "line", sizeFeet: 30 }),
  mk("act_breath_cold_white", "Frost Breath", "8d8", "cold", "CON", 30, undefined, { type: "cone", sizeFeet: 30 }),
  mk("act_breath_fire_black", "Acid Breath (Black)", "10d8", "acid", "CON", 30, undefined, { type: "line", sizeFeet: 60 }),
  mk("act_breath_fire_blue", "Lightning Breath (Blue)", "12d10", "lightning", "CON", 30, undefined, { type: "line", sizeFeet: 30 }),

  // Compact-batch staples for the expanded bestiary.
  mk("act_bite_lg", "Bite (Huge)", "2d10 + @attributes.STR.derived_modifier", "piercing", "STR"),
